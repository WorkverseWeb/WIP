...
export default function Profile() {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `http://localhost:8080/api/user/wip/${wipId}`
        );
  ...
  return (
    <>
      <section className="p-3 p-xxl-5 text-white">
        <div className="border border-1 border-secondary  rounded p-xxl-6 p-lg-5 p-md-4 p-3 ">
            ...
            <div className="d-flex justify-content-between align-items-center mt-5 ">
              <div className="d-flex justify-content-around align-items-start flex-column">
                ...
                <div className="mt-md-5 mt-3 ">
                  <h4 className="mb-2  fw-bold green">{wipData.name}</h4>
                  <p className="mb-2 fs-18">{wipData.designation}</p>
                  <p className="text-secondary mb-0 fs-18">
                    {wipData.organization}
                  </p>
                </div>
              </div>
              {wipData.ceoInMaking && (
          ...
          <div className=" mt-5 d-md-none d-block">
            ...
            <div className="d-flex justify-content-between align-items-center ">
              <div className=" mt-4">
                <h5 className="mb-2 fw-bold green">{wipData.name}</h5>
                <p className="mb-2 fs-18">{wipData.designation}</p>
                <p className="text-secondary mb-0 fs-18">
                  {wipData.organization}
                </p>
          ...
          <p className="fs-18 fs-18 mt-4 m-md-0">{wipData.profileSummary}</p>
        </div>
        <div
          className="mb-3"
          style={{
        ...
        <div className="border border-1 border-secondary rounded p-xxl-6 p-lg-5 p-md-4 p-3 mb-4">
              ...
              <div className="col-12 col-md-6 d-flex justify-content-center align-items-center">
                <div className="custom-loader-wrapper">
                  <div className="circular-progress-capable skill">
                    <CircularProgressbar
                      value={wipData.softskills.skills.creative_Problem_Solving}
                      text={`${wipData.softskills.skills.creative_Problem_Solving}%`}
                      strokeWidth={10}
                      styles={buildStyles({
                        textSize: "14px",
                        pathColor: "#ffcd0c",
          ...
          <div className=" mb-5 mb-xxl-6">
            <div className="d-flex align-items-center gap-4  mb-4 ">
              ...
              <h5 className="greenish m-0">
                {wipData.softskills.smartestAlternative.total_score}%
              </h5>
            </div>

            <h5>
              Innovative, resourceful approach to problem-solving that
              emphasizes simplicity, adaptability, and creativity by making the
              most of available resources and challenging conventional methods.
            </h5>
              ...
              <div className="d-md-flex pt-md-5 justify-content-between align-items-center w-85">
                <div className="custom-loader-wrapper mb-4 mb-md-0">
                  <div className="circular-progress-capable">
                    <CircularProgressbar
                      value={wipData.softskills.smartestAlternative.capable}
                      text={`${wipData.softskills.smartestAlternative.capable}%`}
                      strokeWidth={10}
                      styles={buildStyles({
                        textSize: "14px",
                        pathColor: "#ffcd0c",
                ...
                <div className="custom-loader-wrapper mb-4 mb-md-0">
                  <div className="circular-progress-impressive">
                    <CircularProgressbar
                      value={wipData.softskills.smartestAlternative.impressive}
                      text={`${wipData.softskills.smartestAlternative.impressive}%`}
                      strokeWidth={10}
                      styles={buildStyles({
                        textSize: "14px",
                        pathColor: "#00cbf8",
                ...
                <div className="custom-loader-wrapper mb-4 mb-md-0">
                  <div className="circular-progress-exceptional">
                    <CircularProgressbar
                      value={wipData.softskills.smartestAlternative.exceptional}
                      text={`${wipData.softskills.smartestAlternative.exceptional}%`}
                      strokeWidth={10}
                      styles={buildStyles({
                        textSize: "14px",
                        pathColor: "#47dca5",
          ...
          <div className="mb-5 mb-xxl-6">
            <div className="d-flex align-items-center gap-4  mb-4 ">
              ...
              <span> - </span>
              <h5 className="greenish m-0">
                {wipData.softskills.existingIdeas.total_score}%
              </h5>
            </div>

            <h5 className="mb-5 ">
              Overcoming resource shortages by uncovering unique strategies and
              utilizing available assets more effectively.
            </h5>
            <div className="d-md-flex justify-content-lg-between gap-md-3 gap-lg-0 align-items-center ">
              ...
              <div className="d-md-flex justify-content-between align-items-center w-55">
                <div className="custom-loader-wrapper mb-4 mb-md-0">
                  <div className="circular-progress-capable">
                    <CircularProgressbar
                      value={wipData.softskills.existingIdeas.capable}
                      text={`${wipData.softskills.existingIdeas.capable}%`}
                      strokeWidth={10}
                      styles={buildStyles({
                        textSize: "14px",
                        pathColor: "#ffcd0c",
                ...
                <div className="custom-loader-wrapper mb-4 mb-md-0">
                  <div className="circular-progress-impressive">
                    <CircularProgressbar
                      value={wipData.softskills.existingIdeas.impressive}
                      text={`${wipData.softskills.existingIdeas.impressive}%`}
                      strokeWidth={10}
                      styles={buildStyles({
                        textSize: "14px",
                        pathColor: "#00cbf8",
                ...
                <div className="custom-loader-wrapper mb-4 mb-md-0">
                  <div className="circular-progress-exceptional">
                    <CircularProgressbar
                      value={wipData.softskills.existingIdeas.exceptional}
                      text={`${wipData.softskills.existingIdeas.exceptional}%`}
                      strokeWidth={10}
                      styles={buildStyles({
                        textSize: "14px",
                        pathColor: "#47dca5",
          ...
          <div className="d-flex justify-content-between flex-column flex-md-row mb-5 mb-xxl-6">
            <div className="col-lg-3 col-md-3 col-12 p-0 mt-md-0  mb-5 mb-md-5 text-center text-md-start">
              ...
              <p className="m-0 fs-18">{wipData.softskills.capable}</p>
            </div>
            <div className="divider2 d-none d-md-block"></div>
            <div className="col-lg-3 col-md-3 col-12 p-0  mt-md-0 mb-5 mb-md-5  text-center text-md-start">
              <h4 className="fw-bold blue-green  mb-3">Impressive</h4>
              <p className="m-0 fs-18">{wipData.softskills.impressive}</p>
            </div>
            <div className="divider2 d-none d-md-block"></div>
            <div className="col-lg-3 col-md-3 col-12 p-0  mt-lg-0  mb-md-4 mb-lg-3  text-center text-md-start">
              ...
              <p className="m-0 fs-18">{wipData.softskills.exceptional}</p>
            </div>
          </div>
        </div>
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between">
            <div className="w-100 w-md-50 pe-2 mb-4 mb-md-0">
              ...
              <div
                ...
                aria-valuenow={wipData.workplaceBehaviors.attention_to_detail}
                aria-valuemin="0"
                aria-valuemax="10"
              >
                <div
                  ...
                  style={{
                    width: `${
                      (wipData.workplaceBehaviors.attention_to_detail / 10) *
                      100
                    }%`,
              ...
              <div className="d-flex justify-content-end gap-3 align-items-center pe-7">
                <p className="text-end green">
                  <strong>
                    {wipData.workplaceBehaviors.attention_to_detail}
                  </strong>
                </p>
                <p className="text-end ">
                  {wipData.workplaceBehaviors.attention_to_detail <= 4
                    ? "Occasional"
                    : wipData.workplaceBehaviors.attention_to_detail <= 7
                    ? "Frequent"
                    : "Consistent"}
                </p>
              </div>
            ...
            <div className="w-100 w-md-50 ps-2  mb-4 mb-md-0">
              ...
              <div
                ...
                aria-valuenow={
                  wipData.workplaceBehaviors.application_of_common_sense
                }
                aria-valuemin="0"
                aria-valuemax="10"
              >
              ...
              <div className="d-flex justify-content-end gap-3 align-items-center pe-7">
                ...
                <p className="text-end  ">
                  {wipData.workplaceBehaviors.application_of_common_sense <= 4
                    ? "Occasional"
                    : wipData.workplaceBehaviors.application_of_common_sense <=
                      7
                    ? "Frequent"
              ...
              <div className="d-flex flex-column-reverse flex-md-row justify-content-lg-between gap-md-3 gap-lg-0 align-items-center ">
                <div className="d-md-flex pt-md-5 justify-content-between align-items-center w-85">
                  <div className="custom-loader-wrapper mb-4 mb-md-0">
                    <div className="circular-progress-capable">
                      <CircularProgressbar
                        value={wipData.softskills.lackResources.capable}
                        text="Capable"
                        strokeWidth={10}
                        styles={buildStyles({
                          textSize: "14px",
                  ...
                  <div className="custom-loader-wrapper mb-4 mb-md-0">
                    <div className="circular-progress-impressive">
                      <CircularProgressbar
                        value={wipData.softskills.lackResources.impressive}
                        text="Impressive"
                        strokeWidth={10}
                        styles={buildStyles({
                          textSize: "14px",
                  ...
                  <div className="custom-loader-wrapper mb-4 mb-md-0">
                    <div className="circular-progress-exceptional">
                      <CircularProgressbar
                        value={wipData.softskills.lackResources.exceptional}
                        text="Exceptional"
                        strokeWidth={10}
                        styles={buildStyles({
                          textSize: "14px",
        ...
        <div className="mb-4 border border-1 border-secondary rounded p-xxl-6 p-lg-5 p-md-4 p-3 ">
          ...
          {wipData.analysis.approach_to_work.strengths.length > 0 && (
            <div className={"d-flex align-items-lg-center  mb-xxl-6"}>
              <div className="neuroda d-none d-md-block">
                <img src={neuroda} alt="neuroda" width="100%" />
              </div>
              <div className="soft-skills-wrapper bg-grey-gradient">
                <div className="border border-1 border-secondary rounded shadow-violet soft-skills">
                  <h2 className="greenish m-0 fs-sm-20 d-none d-md-block">
                    {`${wipData.name}'s Approach to Work`}
                  </h2>
                  <div className="d-md-none d-block">
                    <div className="d-flex align-items-center justify-content-between">
                      <h2 className="greenish m-0 fs-sm-20">
            ...
            <div className={"d-flex align-items-lg-center mb-5"}>
              <div className="soft-skills-wrapper1 bg-grey-gradient">
                <div className="border border-1 border-secondary rounded shadow-violet soft-skills1">
                  <h2 className="greenish m-0 fs-sm-20 d-none d-md-block">
                    {`Key traits exhibited by ${wipData.name} at the workplace`}
                  </h2>
                  <div className="d-md-none d-block">
                    <div className="d-flex align-items-center justify-content-between">
                      <h2 className="greenish m-0 fs-sm-20">
                  ...
                  <ul className="py-4 px-xxl-6 px-lg-5 px-md-4 ps-3 mb-0 padding-left">
                    {wipData.analysis.key_traits.strengths.map((a, index) => (
                      <li className="mb-0 fs-18" key={index}>
                        {a}
                      </li>
                    ))}
        ...
        {/* <div className="border border-1 border-secondary rounded p-xxl-6 p-lg-5 p-md-4 p-3 ">
            <div className="d-flex justify-content-between ">
              ...
              <p className="m-0 fw-bold fs-18">
                {wipData.uniqueTraits.filter(Boolean).length}/4
              </p>
            </div>
            <div className="d-flex justify-content-between flex-wrap mt-5 px-lg-5">
              {wipData.uniqueTraits.map((trait, idx) => (
                <div
                  key={idx}
            ...
            {wipData.jobFunction.map((job, idx) => (
              ...
              >
                ...
                <div className="jobfunction-traitsheading">
                  <h5 className="mb-3 lh-20 text-white">
                    {/* {traitsHeading[idx]} */}
                    {job.job_function}
                  </h5>
                  <p className="mb-0  fs-18 lh-20 text-white">
                    {/* {traitsText[idx]} */}
                    {job.description}
                  </p>
                </div>
          ...
          <div className="d-flex justify-content-between flex-wrap mt-xxl-6 mt-5 px-lg-5 d-md-block d-none">
            <div className="d-flex mb-5 justify-content-between flex-wrap">
              <div className="col-lg-3 col-md-3 col-5 p-0 ">
                ...
                <div className="border border-1 rounded-4 bg-black-gradient p-xxl-8 p-md-4 p-2 mx-lg-4">
                  <img src={trainingicon1} alt="trainingicon1" width="70%" />
                </div>
                <div className="d-flex mx-lg-4 mt-2">
                  <h1 className="green fw-bold">
                    {wipData.learningExperience.workplace_tackled}
                  </h1>
                  <span className="ms-2 ms-xxl-4  mt-1 fs-18 lh-20">
                    {wipData.learningExperience.workplace_tackled_Desc}
                  </span>
                </div>
              </div>
              ...
              <div className="col-lg-3 col-md-3 col-5 p-0 ">
                ...
                <div className="d-flex mx-lg-4 mt-2">
                  <h1 className="green  fw-bold">
                    {wipData.learningExperience.unique_models}
                  </h1>
                  <span className="ms-2 ms-xxl-4  mt-1 fs-18  lh-20">
                    {wipData.learningExperience.unique_models_Desc}
                  </span>
                </div>
              </div>
              {/* <div className="divider d-none d-md-block"></div> */}
              ...
              <div className="col-lg-3 col-md-3 col-5 p-0 mt-4 mt-md-0 mb-md-4 mb-lg-3">
                ...
                >
                  ...
                  >
                    {wipData.learningExperience.personalities}
                  </h1>
                  <span
                    className="ms-2 ms-xxl-4 mt-1 fs-18 lh-20 word-break"
                    style={{ overflowWrap: "break-word" }}
                  >
                    {wipData.learningExperience.personalities_Desc}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="d-flex mb-5 justify-content-between flex-wrap">
              <div className="col-lg-3 col-md-3 col-5 p-0 mt-4 mt-md-0  mb-md-4 mb-lg-3">
                ...
                <div className="d-flex mx-lg-4 mt-2">
                  <h1 className="green  fw-bold ">
                    {wipData.learningExperience.professional_emails}
                  </h1>
                  <span className="ms-2 ms-xxl-4  mt-1  fs-18 lh-20">
                    {wipData.learningExperience.professional_emails_Desc}
                  </span>
                </div>
              </div>
              ...
              <div className="col-lg-3 col-md-3 col-5 p-0 mt-4 mt-md-0  mb-md-4 mb-lg-3">
                ...
                <div className="d-flex mx-lg-4 mt-2">
                  <h1 className="green fw-bold ">
                    {wipData.learningExperience.kamai_token}
                  </h1>
                  <span className="ms-2 ms-xxl-4 mt-1 fs-18 lh-20">
                    {wipData.learningExperience.kamai_token_Desc}
                  </span>
                </div>
              </div>
              ...
              <div className="col-lg-3 col-md-3 col-5 p-0 mt-4 mt-md-0  mb-md-4 mb-lg-3">
                ...
                <div className="d-flex mx-lg-4 mt-2">
                  <h1 className="green  fw-bold  ">
                    {wipData.learningExperience.workplace_simulation}
                  </h1>
                  <span className="ms-2 ms-xxl-4 mt-1 fs-18 lh-20">
                    {wipData.learningExperience.workplace_simulation_Desc}
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="mt-3 border border-1 border-secondary rounded p-xxl-6 p-lg-5 p-md-4 p-3 ">
          ...
          <div className="d-md-flex justify-content-evenly align-items-center">
            {Object.keys(wipData.badges).map(
              (badgeName, index) =>
